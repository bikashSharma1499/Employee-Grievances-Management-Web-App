...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li >
				<a href="hr_logged_panel.jsp">
					<i class='bx bxs-dashboard' ></i>
					<span class="text">Dashboard</span>
				</a>
			</li>
			<li>
                            <a href="hr_logged_panel_MyProfile.jsp" id="clickProfile">
			...
			<li>
				<a id="changePass" href="#">
					...
					<span class="text">Change Password</span>
                        ...
                        <li class="active">
				<a href="hr_logged_panel_Grievances.jsp">
					<i class='bx bxs-message-dots' ></i>
					<span class="text">Grievances</span>
				</a>
			</li>
                        <li>
                            <a href="hr_logged_panel_addEmployeeInfo.jsp">
		...
		<ul class="side-menu">
			<li>
				<a href="hr-login.jsp" class="logout">
								...
								<td> <%@page import="java.sql.*" %><% 
                                                                 ...
                                                                 String url = "jdbc:oracle:thin:@//localhost:1521/XE";
                                                                    String user = "system";
                                                                     ...
                                                                     String data="";
                                                                        PreparedStatement pst=con.prepareStatement("select empid from employeeEGS where userid=?" );
                                                                        pst.setString(1, "bikashemp");
                                                                ...
                                                                <% try{
                                                                 ...
                                                                 String url = "jdbc:oracle:thin:@//localhost:1521/XE";
                                                                    String user = "system";
                                                                     Connection con = DriverManager.getConnection(url, user, "root");
                                                                     String data="";
                                                                        PreparedStatement pst=con.prepareStatement("select fullname from employeeEGS where userid=?" );
                                                                        pst.setString(1, "bikashemp");
                                                                        ResultSet rs =pst.executeQuery();
                                                                        while(rs.next()){
                                                                          data=rs.getString(1);
                                                                ...
                                                                <td>
                                                                 ...
                                                                 String url = "jdbc:oracle:thin:@//localhost:1521/XE";
                                                                    String user = "system";
                                                                     Connection con = DriverManager.getConnection(url, user, "root");
                                                                     String data="";
                                                                        PreparedStatement pst=con.prepareStatement("select email from employeeEGS where userid=?" );
                                                                        pst.setString(1, "bikashemp");
                                                                        ResultSet rs =pst.executeQuery();
                                                                        while(rs.next()){
                                                                          data=rs.getString(1);
								...
								<td><% try{
                                                                 ...
                                                                 String url = "jdbc:oracle:thin:@//localhost:1521/XE";
                                                                    String user = "system";
                                                                     Connection con = DriverManager.getConnection(url, user, "root");
                                                                     String data="";
                                                                        PreparedStatement pst=con.prepareStatement("select gender from employeeEGS where userid=?" );
                                                                        pst.setString(1, "bikashemp");
                                                                        ResultSet rs =pst.executeQuery();
                                                                        while(rs.next()){
                                                                          data=rs.getString(1);
								...
								<td><% try{
                                                                 ...
                                                                 String url = "jdbc:oracle:thin:@//localhost:1521/XE";
                                                                    String user = "system";
                                                                     Connection con = DriverManager.getConnection(url, user, "root");
                                                                     String data="";
                                                                        PreparedStatement pst=con.prepareStatement("select state from employeeEGS where userid=?" );
                                                                        pst.setString(1, "bikashemp");
                                                                        ResultSet rs =pst.executeQuery();
                                                                        while(rs.next()){
                                                                          data=rs.getString(1);
