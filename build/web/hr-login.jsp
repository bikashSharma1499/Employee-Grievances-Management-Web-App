...
<body>
  ...
  <div class="container">
    <h2>HR Login</h2>
    <form method="post" action="validateHRLogin.jsp">
  ...
  <a href="hr-reg.jsp" style="display: inline; width: 20px; background-color: navy;color: white;text-decoration: none;padding: 5px;">Register here</a>
</div>
    </form>
  </div>
