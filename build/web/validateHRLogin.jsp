...
<html>
  ...
  PreparedStatement pst=con.prepareStatement("select userid, pass2 from hrEGS where userid=? and pass2=?");
 ...
 if((userIdDb.equals(userIdG)) && (passDb.equals(pass2G))){
     response.sendRedirect("hr_logged_panel.jsp");
 }else{
        
 response.sendRedirect("hr_login.jsp?message=failed");
 }
