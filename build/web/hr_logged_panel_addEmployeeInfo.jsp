				...
				<div class="order">
					<div class="head">
						<h3>Add Employee Information</h3>
                                    ...
                                    <form action="addEmployeeDatabyHR.jsp">	
                                    <table>
						...
						<tbody>
							<tr>
								...
								<td>                                                                  
                                                                    <input class="status completed" type="number" name="empid" >
                                                                    </td>
							...
							<tr>
								...
								<td>
                                                                  <input class="status completed" type="text" name="name" >
							...
							<tr>
								<td>
									...
									<p>Email Id</p>
                                                                ...
                                                                <td>
                                                                   <input class="status completed" type="text" name="emailid" >
								...
								<td>
                                                                ...
                                                                <td>
                                                                   <input class="status completed" type="submit" value="Register" style="cursor: pointer;">
