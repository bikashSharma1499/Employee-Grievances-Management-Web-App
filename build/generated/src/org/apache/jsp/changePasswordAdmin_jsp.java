...
public final class changePasswordAdmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("       ");
 try{
           String passG= request.getParameter("newPassword");
           ...
           Class.forName("oracle.jdbc.driver.OracleDriver");
              ...
              String user = "system";
               Connection con = DriverManager.getConnection(url, user, "root");
                String data="";
                 PreparedStatement pst=con.prepareStatement("update adminRegEgs set pass1=? and pass2=? where userid=?" );
